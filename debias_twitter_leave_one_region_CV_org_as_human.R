###############################################################################################################################
# leave-one-region-out cross-validation for all the models in the paper. However, the dataset is when M3-inference tool treats organization as human
#BTT: Zagheni's model
...
fb_data1 =  read.csv("data/P_nuts3_df_data_Ni.orgs-as-humans.csv")

# fb_data3 is  the dataframe for the models assuming inhomogeneous bias
fb_data3 =  read.csv("data/P_nuts3_df_data_NiXZ.orgs-as-humans.csv")
...
print(eval_results)
write.csv(eval_results, file = "result/Eval_results_byCity_org_as_human.csv.csv")
