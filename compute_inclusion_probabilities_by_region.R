###############################################################################################################################
# compute the inclusion probabilities for nuts3_regions
###############################################################################################################################
...
colnames(incl_probs_df) <- c("incl_prob", "nuts3", "age", "gender", "country")
setcolorder(incl_probs_df, c("nuts3", "age", "gender", "incl_prob", "country"))

write.csv(incl_probs_df, file = "result/inclusion_probabilities_city.csv")
